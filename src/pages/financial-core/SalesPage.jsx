...
import { GET_DASHBOARD_SUMMARY } from "../../services/endPoints";
import { getDashboardData } from "../../apiCalls/salesAPI/salesAPICall";
...
export default function SalesPage() {
  ...
  const handleGetDashBoardData = async () => {
    const response = await getDashboardData(GET_DASHBOARD_SUMMARY);
                ...
                <div className="sales-metrics-grid">
                  ...
                  <div className="sales-metric-card">
                    ...
                    <div className="metric-content">
                      ...
                      <p className="metric-subtitle">
                        <span style={{ color: "#00A63E" }}>+12.5%</span> vs last
                        month
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="sales-metric-card">
                    <div className="metric-header">
                      <div className="metric-icon-wrapper purple">
                        ...
                        >
                          ...
                          />
                          <path
                            d="M11.6666 1.66602V4.99935C11.6666 5.44138 11.8422 5.8653 12.1548 6.17786C12.4673 6.49042 12.8913 6.66602 13.3333 6.66602H16.6666"
                            stroke="#9810FA"
                            stroke-width="1.66667"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                    ...
                    <div className="metric-content">
                      ...
                      <p className="metric-subtitle">
                        <span style={{ color: "#E02424" }}>-3</span> vs last
                        month
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="sales-metric-card">
                    ...
                    <div className="metric-content">
                      ...
                      <p className="metric-subtitle">
                        <span style={{ color: "#00A63E" }}>+8.2%</span> vs last
                        month
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="sales-metric-card">
                    ...
                    <div className="metric-content">
                      ...
                      <p className="metric-subtitle">
                        <span style={{ color: "#00A63E" }}>+15.3%</span> vs last
                        month
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="sales-metric-card">
                    <div className="metric-header">
                      <div className="metric-icon-wrapper orange">
                        ...
                        >
                          <path
                            d="M9.99999 18.3327C14.6024 18.3327 18.3333 14.6017 18.3333 9.99935C18.3333 5.39698 14.6024 1.66602 9.99999 1.66602C5.39762 1.66602 1.66666 5.39698 1.66666 9.99935C1.66666 14.6017 5.39762 18.3327 9.99999 18.3327Z"
                            stroke="#F54900"
                            stroke-width="1.66667"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                    ...
                    <div className="metric-content">
                      ...
                      <p className="metric-subtitle">
                        <span style={{ color: "#E02424" }}>-2 days</span> vs
                        last month
                      </p>
                    </div>
                  </div>
                          ...
                          <div className={`activity-icon ${activity.type}`}>
                            {activity.icon === "check" && (
                              ...
                              >
                                ...
                                <g clip-path="url(#clip0_261_4008)">
                                  <path
                                    d="M16 22.6673C19.6819 22.6673 22.6667 19.6825 22.6667 16.0007C22.6667 12.3188 19.6819 9.33398 16 9.33398C12.3181 9.33398 9.33337 12.3188 9.33337 16.0007C9.33337 19.6825 12.3181 22.6673 16 22.6673Z"
                                    stroke="#007A55"
                                  ...
                                  />
                                  <path
                                    d="M14 15.9993L15.3333 17.3327L18 14.666"
                                    stroke="#007A55"
                                    stroke-width="1.33333"
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                            ...
                            {activity.icon === "file" && (
                              ...
                              >
                                ...
                                />
                                <path
                                  d="M18 9.33398H12C11.6463 9.33398 11.3072 9.47446 11.0572 9.72451C10.8071 9.97456 10.6666 10.3137 10.6666 10.6673V21.334C10.6666 21.6876 10.8071 22.0267 11.0572 22.2768C11.3072 22.5268 11.6463 22.6673 12 22.6673H20C20.3536 22.6673 20.6927 22.5268 20.9428 22.2768C21.1928 22.0267 21.3333 21.6876 21.3333 21.334V12.6673L18 9.33398Z"
                                  stroke="#1447E6"
                                  stroke-width="1.33333"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                />
                                <path
                                  d="M17.3334 9.33398V12.0007C17.3334 12.3543 17.4739 12.6934 17.7239 12.9435C17.9739 13.1935 18.3131 13.334 18.6667 13.334H21.3334"
                                  stroke="#1447E6"
                                  stroke-width="1.33333"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                  ...
                  <div className="sales-section top-customers">
                    <div className="section-header">
                      <div className="section-icon">
                        ...
                        >
                          <path
                            d="M18.3334 5.83398L11.25 12.9173L7.08335 8.75065L1.66669 14.1673"
                            stroke="#155DFC"
                            stroke-width="1.66667"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                          ...
                          <div className="customer-icon">
                            ...
                            >
                              ...
                              <g clip-path="url(#clip0_261_4080)">
                                <path
                                  d="M12 22.6673V10.6673C12 10.3137 12.1405 9.97456 12.3905 9.72451C12.6406 9.47446 12.9797 9.33398 13.3333 9.33398H18.6667C19.0203 9.33398 19.3594 9.47446 19.6095 9.72451C19.8595 9.97456 20 10.3137 20 10.6673V22.6673H12Z"
                                  stroke="#1447E6"
                                  stroke-width="1.33333"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                />
                                <path
                                  d="M12 16H10.6666C10.313 16 9.97389 16.1405 9.72384 16.3905C9.47379 16.6406 9.33331 16.9797 9.33331 17.3333V21.3333C9.33331 21.687 9.47379 22.0261 9.72384 22.2761C9.97389 22.5262 10.313 22.6667 10.6666 22.6667H12"
                                  stroke="#1447E6"
                                  stroke-width="1.33333"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                                />
                                <path
                                  d="M20 14H21.3333C21.687 14 22.0261 14.1405 22.2761 14.3905C22.5262 14.6406 22.6667 14.9797 22.6667 15.3333V21.3333C22.6667 21.687 22.5262 22.0261 22.2761 22.2761C22.0261 22.5262 21.687 22.6667 21.3333 22.6667H20"
                                  stroke="#1447E6"
                                  stroke-width="1.33333"
                                  stroke-linecap="round"
                                  stroke-linejoin="round"
                ...
                <div className="sales-section enterprise-controls">
                  <div className="section-header has-subtitle">
                    ...
                    <p className="section-subtitle">
                      Configure AR automation and compliance settings
                    </p>
                  </div>
                    ...
                    <div className="control-item">
                      <div className="control-left">
                        <div className="control-icon blue">
                          ...
                          >
                            <path
                              d="M13.3333 8.66762C13.3333 12.001 11 13.6676 8.22663 14.6343C8.0814 14.6835 7.92365 14.6811 7.77996 14.6276C4.99996 13.6676 2.66663 12.001 2.66663 8.66762V4.00095C2.66663 3.82414 2.73686 3.65457 2.86189 3.52955C2.98691 3.40452 3.15648 3.33428 3.33329 3.33428C4.66663 3.33428 6.33329 2.53428 7.49329 1.52095C7.63453 1.40028 7.8142 1.33398 7.99996 1.33398C8.18572 1.33398 8.36539 1.40028 8.50663 1.52095C9.67329 2.54095 11.3333 3.33428 12.6666 3.33428C12.8434 3.33428 13.013 3.40452 13.138 3.52955C13.2631 3.65457 13.3333 3.82414 13.3333 4.00095V8.66762Z"
                              stroke="#1447E6"
                              stroke-width="1.33333"
                              stroke-linecap="round"
                              stroke-linejoin="round"
                        ...
                        <div className="control-icon green">
                          ...
                          >
                            <g clip-path="url(#clip0_261_4198)">
                              ...
                              />
                              <path
                                d="M8.00004 1.33398C6.2882 3.13142 5.33337 5.51848 5.33337 8.00065C5.33337 10.4828 6.2882 12.8699 8.00004 14.6673C9.71188 12.8699 10.6667 10.4828 10.6667 8.00065C10.6667 5.51848 9.71188 3.13142 8.00004 1.33398Z"
                                stroke="#007A55"
                                stroke-width="1.33333"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                        ...
                        <div className="control-icon purple">
                          ...
                          >
                            <g clip-path="url(#clip0_261_4225)">
                              <path
                                d="M4 14.6673V2.66732C4 2.3137 4.14048 1.97456 4.39052 1.72451C4.64057 1.47446 4.97971 1.33398 5.33333 1.33398H10.6667C11.0203 1.33398 11.3594 1.47446 11.6095 1.72451C11.8595 1.97456 12 2.3137 12 2.66732V14.6673H4Z"
                                stroke="#432DD7"
                                stroke-width="1.33333"
                                stroke-linecap="round"
                                stroke-linejoin="round"
