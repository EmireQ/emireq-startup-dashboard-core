...
import {
  ...
  getTransactionsList,
  uploadTransaction,
} from "../../apiCalls/transactionAPI/transactionAPICall";
import {
  CREATE_TRANSACTIONS,
  JOURNAL_ENTRIES,
  LIST_TRANSACTIONS,
...
import { getJournalList } from "../../apiCalls/journalAPI/journalAPICall";
...
export default function TransactionsPage() {
  ...
  const [showJournalStatusDropdown, setShowJournalStatusDropdown] =
    useState(false);
  ...
  const filteredJournals = allJournals.filter((journal) => {
    const matchesSearch =
      journal.id.toLowerCase().includes(journalSearchQuery.toLowerCase()) ||
      journal.sourceTxn
        .toLowerCase()
        .includes(journalSearchQuery.toLowerCase());
    const matchesType =
      journalTypeFilter === "all" ||
      journal.type.toLowerCase() === journalTypeFilter.toLowerCase();
    const matchesStatus =
      journalStatusFilter === "all" ||
      journal.status.toLowerCase() === journalStatusFilter.toLowerCase();
    return matchesSearch && matchesType && matchesStatus;
  });

  const totalJournalResults = filteredJournals.length;
  const journalItemsPerPage = 6;
  const totalJournalPages = Math.ceil(
    totalJournalResults / journalItemsPerPage,
  );
  const journalStartIndex = (journalCurrentPage - 1) * journalItemsPerPage;
  const displayedJournals = filteredJournals.slice(
    journalStartIndex,
    journalStartIndex + journalItemsPerPage,
  );
    ...
    if (files && files.length > 0) {
      ...
      if (file.type === "text/csv" || file.name.endsWith(".csv")) {
        if (file.size <= 10 * 1024 * 1024) {
          ...
          formData.append("file", file); // backend key may vary
          const res = await uploadTransaction(
            UPLOAD_TRANSACTION, // your API endpoint
            formData,
          );
  ...
  const handleCreateTransaction = async () => {
    ...
    const response = await createTransaction(CREATE_TRANSACTIONS, payload);
    console.log("response", response);
  };

  const getAllTransactions = async () => {
    const getTransactions = await getTransactionsList(LIST_TRANSACTIONS);
    console.log(getTransactions);
  };

  const getJournals = async () => {
    const response = await getJournalList(JOURNAL_ENTRIES);
    console.log("response", response);
  };
          ...
          <div className="transactions-container">
            ...
            <div className="transactions-page-header">
              <div className="page-header-left">
                ...
                <p>
                  Manage and track all your financial transactions and journal
                  entries
                </p>
              </div>
              <div className="page-header-actions">
                <button className="btn-secondary" onClick={handleExport}>
                  ...
                  >
                    <path
                      d="M14 10.6667V13.3334C14 13.5102 13.9298 13.6798 13.8047 13.8048C13.6797 13.9299 13.5101 14.0001 13.3333 14.0001H2.66667C2.48986 14.0001 2.32029 13.9299 2.19526 13.8048C2.07024 13.6798 2 13.5102 2 13.3334V10.6667"
                      stroke="currentColor"
                      strokeWidth="1.33333"
                      strokeLinecap="round"
            ...
            {activeTab === "all" && (
              <div className="transactions-section">
                <div className="section-header">
                  <div className="section-header-left">
                    <div className="section-title">
                      ...
                      <button
                        className="info-icon"
                        title="Manage and track all your financial transactions and journal entries"
                      >
                        <svg
                          width="20"
                          height="20"
                    ...
                    <p className="section-description">
                      Manage and track all your financial transactions and
                      journal entries
                    </p>
                  </div>
                </div>
                    ...
                    <tbody>
                      {displayedTransactions.map((txn) => (
                        <tr key={txn.id}>
                          ...
                          <td>
                            <span className={getTypeClass(txn.type)}>
                              {txn.type}
                            </span>
                          </td>
                ...
                <div className="transactions-pagination">
                  <div className="pagination-info">
                    ...
                    <input
                      ...
                      value={String(displayedTransactions.length).padStart(
                        2,
                        "0",
                      )}
                      readOnly
                ...
                <div className="transactions-footer-note">
                  Market data is updated in real-time. Prices are for reference
                  only and may vary across exchanges.
                </div>
              </div>
            )}
              ...
              <div className="upload-transactions-section">
                ...
                <div className="csv-template-box">
                  ...
                  <div className="template-content">
                    <h3>CSV Template</h3>
                    <p>
                      Download our CSV template to ensure your file is formatted
                      correctly for bulk import.
                    </p>
                    <button
                    ...
                    >
                      ...
                      >
                        <path
                          d="M17.5 13.3334V16.6667C17.5 17.1087 17.3244 17.5326 17.0118 17.8452C16.6993 18.1577 16.2754 18.3334 15.8333 18.3334H4.16667C3.72464 18.3334 3.30072 18.1577 2.98816 17.8452C2.67559 17.5326 2.5 17.1087 2.5 16.6667V13.3334"
                          stroke="currentColor"
                          strokeWidth="1.66667"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                ...
                <div className="file-requirements">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <span>
                        Required columns: Date, Type, Description, Category,
                        Amount, Account
                      </span>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <span>
                        Amount format: Positive for income, negative for
                        expenses
                      </span>
                    </li>
                  </ul>
                    ...
                    <div className="dropdown">
                      ...
                      {showJournalStatusDropdown && (
                        <div className="dropdown-menu">
                          ...
                          <button
                            onClick={() => {
                              setJournalStatusFilter("Completed");
                              setShowJournalStatusDropdown(false);
                            }}
                          >
                            Completed
                          ...
                          <button
                            onClick={() => {
                              setJournalStatusFilter("Processing");
                              setShowJournalStatusDropdown(false);
                            }}
                          >
                            Processing
                          ...
                          <button
                            onClick={() => {
                              setJournalStatusFilter("Pending");
                              setShowJournalStatusDropdown(false);
                            }}
                          >
                            Pending
                      ...
                      {displayedJournals.map((journal) => (
                        <tr key={journal.id}>
                          ...
                          <td className="journal-source">
                            <span className="source-txn-badge">
                              {journal.sourceTxn}
                            </span>
                          </td>
                ...
                <div className="transactions-pagination journals-pagination">
                  <div className="pagination-info">
                    ...
                    <input
                      type="text"
                      className="pagination-count"
                      value={String(displayedJournals.length).padStart(2, "0")}
                      readOnly
                    />{" "}
                    / {totalJournalResults} Results
                  </div>
                  <div className="pagination-controls">
                    <button
                      className="pagination-button"
                      onClick={() =>
                        setJournalCurrentPage((prev) => Math.max(1, prev - 1))
                      }
                    ...
                    {journalCurrentPage > 3 && journalCurrentPage < 10 && (
                      <>
                        ...
                        <button
                          className="pagination-number active"
                          onClick={() =>
                            setJournalCurrentPage(journalCurrentPage)
                          }
                        >
                          {journalCurrentPage}
                        </button>
                    ...
                    <button
                      className="pagination-button"
                      onClick={() =>
                        setJournalCurrentPage((prev) =>
                          Math.min(totalJournalPages, prev + 1),
                        )
                      }
