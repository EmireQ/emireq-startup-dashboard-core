...
import { getPaymentData } from "../../apiCalls/salesAPI/salesAPICall";
import { LIST_PAYMENT } from "../../services/endPoints";
...
export default function PaymentsView({ isDarkMode }) {
  ...
  const filteredPayments = payments.filter((payment) => {
    ...
    const matchesCustomer =
      selectedCustomer === "All" || payment.customer === selectedCustomer;
    ...
    // Status filter
    const matchesStatus =
      selectedStatus === "All" || payment.allocated === selectedStatus;
  ...
  const renderPageNumbers = () => {
    ...
    if (currentPage === 1) {
      ...
      pages.push(
        <span key="ellipsis1" className="pagination-dots">
          ...
        </span>,
      );
      pages.push(
  ...
  const handleGetPaymentData = () => {
    const response = getPaymentData(LIST_PAYMENT);
    ...
    <div className={`payments-view ${isDarkMode ? "dark-mode" : ""}`}>
        ...
        <div className="payments-header-left">
          <div className="payments-title-row">
            ...
            <button
              ...
              title="Information about payments"
            >
              <svg
                width="16"
                height="16"
      ...
      <div className="table-pagination">
        <div className="pagination-info">
          Showing{" "}
          <span className="pagination-number-box">
            {String(paginatedPayments.length).padStart(2, "0")}
          </span>{" "}
          <span className="pagination-separator">/</span> {totalResults} Results
        </div>
