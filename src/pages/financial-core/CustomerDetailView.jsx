      ...
      <div className="customer-info-container">
        ...
        <div className="customer-header">
          ...
          <div className="customer-actions">
            <button className="btn-secondary">
              ...
              >
                <path
                  d="M7.33334 2.66667H2.66667C2.31305 2.66667 1.97391 2.80714 1.72386 3.05719C1.47381 3.30724 1.33334 3.64638 1.33334 4V13.3333C1.33334 13.687 1.47381 14.0261 1.72386 14.2761C1.97391 14.5262 2.31305 14.6667 2.66667 14.6667H12C12.3536 14.6667 12.6928 14.5262 12.9428 14.2761C13.1929 14.0261 13.3333 13.687 13.3333 13.3333V8.66667"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M12.3333 1.66665C12.5986 1.40144 12.9582 1.25244 13.3333 1.25244C13.7085 1.25244 14.0681 1.40144 14.3333 1.66665C14.5985 1.93187 14.7475 2.29158 14.7475 2.66665C14.7475 3.04173 14.5985 3.40144 14.3333 3.66665L8.00001 9.99999L5.33334 10.6667L6.00001 7.99999L12.3333 1.66665Z"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
        ...
        <div className="customer-stats">
          ...
          <div className="stat-box">
            ...
            <div className="stat-value-large overdue">
              ...
              <div className="info-card">
                ...
                <div className="info-rows">
                  ...
                  <div className="info-row">
                    ...
                    <span className="info-value">
                      {customer.creditLimit || "$500,000"}
                    </span>
                  </div>
                  <div className="info-row">
                    <span className="info-label">Status</span>
                    <span className="info-value">
                      <span className="status-badge-inline active">
              ...
              <div className="info-card">
                ...
                <div className="info-rows">
                  ...
                  <div className="info-row">
                    ...
                    <span className="info-value">
                      {customer.billingAddress || "123 Business St, Suite 100"}
                    </span>
                  </div>
                  <div className="info-row">
                    <span className="info-label">Tax ID</span>
                    <span className="info-value">
                      {customer.taxId || "XX-XXXXXXX"}
                    </span>
                  </div>
                  <div className="info-row">
                    <span className="info-label">Sales Owner</span>
                    <span className="info-value">
                      {customer.salesOwner || "John Smith"}
                    </span>
                  </div>
                </div>
              </div>
                  ...
                  <tbody>
                    {invoices.map((invoice) => (
                      <tr key={invoice.id}>
                        ...
                        <td>
                          <div
                            className={`amount-value ${invoice.status === "overdue" ? "overdue" : ""}`}
                          >
                            {invoice.balanceDue}
                          </div>
                        </td>
                        <td>
                          <span
                            className={`status-badge-detail ${invoice.status}`}
                          >
                        ...
                        <td>
                          <div className="action-icons">
                            <button className="icon-btn" title="View">
                              ...
                              >
                                <path
                                  d="M1.33334 8C1.33334 8 3.33334 3.33333 8.00001 3.33333C12.6667 3.33333 14.6667 8 14.6667 8C14.6667 8 12.6667 12.6667 8.00001 12.6667C3.33334 12.6667 1.33334 8 1.33334 8Z"
                                  stroke="currentColor"
                                  strokeWidth="1.5"
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
                            ...
                            <button className="icon-btn" title="Send">
                              ...
                              >
                                ...
                                />
                                <path
                                  d="M14.6667 2L10 14L7.33333 9.33333L2.66666 6.66667L14.6667 2Z"
                                  stroke="currentColor"
                                  strokeWidth="1.5"
                                  strokeLinecap="round"
                                  strokeLinejoin="round"
            ...
            <div className="activity-section">
              <div className="section-header-row">
                <div className="section-title-block">
                  <h3>Activity Log</h3>
                  <p className="section-subtitle">
                    Recent activities and changes for this customer
                  </p>
                </div>
                <button className="btn-secondary">
                  <svg
              ...
              <div className="activity-timeline">
                {activityLog.map((activity) => (
                  <div
                    key={activity.id}
                    className={`activity-entry ${activity.type}`}
                  >
                    <div className={`activity-icon-wrapper ${activity.type}`}>
                      ...
                      {activity.icon === "file" && (
                        ...
                        >
                          ...
                          />
                          <path
                            d="M11.6666 1.66602V6.66602H16.6666"
                            stroke="currentColor"
                            strokeWidth="1.67"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                      ...
                      {activity.icon === "edit" && (
                        ...
                        >
                          ...
                          />
                          <path
                            d="M15.4167 2.08398C15.7482 1.75251 16.1978 1.56641 16.6667 1.56641C17.1355 1.56641 17.5852 1.75251 17.9167 2.08398C18.2481 2.41546 18.4342 2.86514 18.4342 3.33398C18.4342 3.80283 18.2481 4.25251 17.9167 4.58398L10 12.5007L6.66666 13.334L7.49999 10.0007L15.4167 2.08398Z"
                            stroke="currentColor"
                            strokeWidth="1.67"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                      ...
                      {activity.icon === "bell" && (
                        ...
                        >
                          <path
                            d="M15 6.66602C15 5.34058 14.4732 4.06877 13.5355 3.13109C12.5979 2.19341 11.3261 1.66602 10 1.66602C8.67392 1.66602 7.40215 2.19341 6.46447 3.13109C5.52678 4.06877 5 5.34058 5 6.66602C5 12.4993 2.5 14.166 2.5 14.166H17.5C17.5 14.166 15 12.4993 15 6.66602Z"
                            stroke="currentColor"
                            strokeWidth="1.67"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                          <path
                            d="M11.4417 17.5C11.2952 17.7526 11.0849 17.9622 10.8319 18.1079C10.5789 18.2537 10.292 18.3304 10 18.3304C9.70802 18.3304 9.42109 18.2537 9.16808 18.1079C8.91508 17.9622 8.70484 17.7526 8.55833 17.5"
                            stroke="currentColor"
                            strokeWidth="1.67"
                            strokeLinecap="round"
                            strokeLinejoin="round"
