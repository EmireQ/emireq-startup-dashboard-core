...
import { getSubcriptionProvider } from "../../apiCalls/startupAPI/startupAPICall";
import { SUBSCRIPTION_PROVIDER } from "../../services/endPoints";
...
export default function FinancialCorePage() {
  ...
  const handleGetSubscription = async () => {
    const response = await getSubcriptionProvider(SUBSCRIPTION_PROVIDER);
              ...
              <div className="status-banner-content">
                <div className="status-icon">
                  ...
                  >
                    ...
                    />
                    <path
                      d="M14 22.3333C18.6023 22.3333 22.3333 18.6024 22.3333 14C22.3333 9.39762 18.6023 5.66666 14 5.66666C9.39759 5.66666 5.66663 9.39762 5.66663 14C5.66663 18.6024 9.39759 22.3333 14 22.3333Z"
                      stroke="white"
                    ...
                    />
                    <path
                      d="M11.5 14L13.1667 15.6667L16.5 12.3333"
                      stroke="white"
                      stroke-width="1.66667"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                  ...
                  <div className="metric-card">
                    <div className="metric-header">
                      ...
                      <div className="metric-trend positive">
                        ...
                        >
                          <path
                            d="M12.254 6.4668H16.254V10.4668"
                            stroke="#00A63E"
                            strokeWidth="1.33333"
                            strokeLinecap="round"
                          ...
                          />
                          <path
                            d="M16.254 6.4668L10.587 12.1335L7.254 8.8001L2.921 13.1335"
                            stroke="#00A63E"
                            strokeWidth="1.33333"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                  ...
                  <div className="metric-card">
                    <div className="metric-header">
                      ...
                      <div className="metric-trend positive">
                        ...
                        >
                          <path
                            d="M12.917 6.4668H16.917V10.4668"
                            stroke="#00A63E"
                            strokeWidth="1.33333"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                          <path
                            d="M16.917 6.4668L11.25 12.1335L7.917 8.8001L3.583 13.1335"
                            stroke="#00A63E"
                            strokeWidth="1.33333"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                    ...
                    <div className="metric-header">
                      ...
                      <div className="metric-trend positive">
                        ...
                        >
                          ...
                          />
                          <path
                            d="M16.567 6.055L10.9 11.721L7.567 8.388L3.233 12.721"
                            stroke="#00A63E"
                            strokeWidth="1.33333"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                    ...
                    <div className="metric-header">
                      ...
                      <div className="metric-trend positive">
                        ...
                        >
                          ...
                          />
                          <path
                            d="M16.204 6.055L10.538 11.721L7.204 8.388L2.871 12.721"
                            stroke="#00A63E"
                            strokeWidth="1.33333"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                ...
                <div className="chart-card">
                  ...
                  <div className="chart-container">
                    ...
                    >
                      ...
                      {/* Y-axis labels */}
                      <text x="47" y="221" className="chart-label">
                        0
                      </text>
                      <text x="18" y="168" className="chart-label">
                        20000
                      </text>
                      <text x="18" y="114" className="chart-label">
                        40000
                      </text>
                      <text x="18" y="61" className="chart-label">
                        60000
                      </text>
                      <text x="18" y="11" className="chart-label">
                        80000
                      </text>

                      {/* Revenue Area with Gradient */}
                      <path
                        d="M 57.812 97.8382C100.208 88.4992 142.604 79.1602 185 79.1602C227.396 79.1602 269.792 89.8333 312.188 89.8333C354.584 89.8333 396.98 55.1457 439.376 55.1457C481.773 55.1457 524.168 63.1505 566.564 63.1505C608.961 63.1505 651.356 51.1433 693.752 39.136V217.911C651.356 217.911 608.961 217.911 566.564 217.911C524.168 217.911 481.773 217.911 439.376 217.911C396.98 217.911 354.584 217.911 312.188 217.911C269.792 217.911 227.396 217.911 185 217.911C142.604 217.911 100.208 217.911 57.812 217.911V97.8382Z"
                      ...
                      {/* Revenue Line */}
                      <path
                        d="M 57.812 97.8382C100.208 88.4992 142.604 79.1602 185 79.1602C227.396 79.1602 269.792 89.8333 312.188 89.8333C354.584 89.8333 396.98 55.1457 439.376 55.1457C481.773 55.1457 524.168 63.1505 566.564 63.1505C608.961 63.1505 651.356 51.1433 693.752 39.136"
                      ...
                      <path
                        d="M 57.8123 132.525C100.209 129.856 142.604 127.188 185 124.52C227.397 121.851 269.792 119.628 312.188 116.515C354.585 113.402 396.98 108.955 439.376 105.842C481.773 102.729 524.168 100.505 566.565 97.8369C608.961 95.1686 651.356 92.5003 693.753 89.832V217.91C651.356 217.91 608.961 217.91 566.565 217.91C524.168 217.91 481.773 217.91 439.376 217.91C396.98 217.91 354.585 217.91 312.188 217.91C269.792 217.91 227.397 217.91 185 217.91C142.604 217.91 100.209 217.91 57.8123 217.91V132.525Z"
                      ...
                      {/* Expenses Line */}
                      <path
                        d="M 57.8123 132.525C100.209 129.856 142.604 127.188 185 124.52C227.397 121.851 269.792 119.628 312.188 116.515C354.585 113.402 396.98 108.955 439.376 105.842C481.773 102.729 524.168 100.505 566.565 97.8369C608.961 95.1686 651.356 92.5003 693.753 89.832"
                      ...
                      {/* Balance Line */}
                      <path
                        d="M 57.813 183.223C100.209 177.886 142.605 172.55 185.001 172.55C227.397 172.55 269.793 191.228 312.189 191.228C354.585 191.228 396.981 167.213 439.377 167.213C481.773 167.213 524.169 183.223 566.565 183.223C608.962 183.223 651.357 175.218 693.753 167.213"
                      ...
                      {/* X-axis Labels */}
                      <text x="52" y="232" className="chart-label-x">
                        Jan
                      </text>
                      <text x="177" y="232" className="chart-label-x">
                        Feb
                      </text>
                      <text x="304" y="232" className="chart-label-x">
                        Mar
                      </text>
                      <text x="431" y="232" className="chart-label-x">
                        Apr
                      </text>
                      <text x="558" y="232" className="chart-label-x">
                        May
                      </text>
                      <text x="685" y="232" className="chart-label-x">
                        Jun
                      </text>
                    </svg>
                  </div>
                      ...
                      <div key={tx.id} className="activity-item">
                        <div className={`activity-icon-wrapper ${tx.status}`}>
                          {tx.status === "incoming" ? (
                            ...
                            >
                              <path
                                d="M4.66675 4.66602L11.3334 11.3327"
                                stroke="#00A63E"
                              ...
                              />
                              <path
                                d="M11.3334 4.66602V11.3327H4.66675"
                                stroke="#00A63E"
                                stroke-width="1.33333"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                            ...
                            >
                              <path
                                d="M4.66675 4.66602H11.3334V11.3327"
                                stroke="#E7000B"
                                stroke-width="1.33333"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                              />
                              <path
                                d="M4.66675 11.3327L11.3334 4.66602"
                                stroke="#E7000B"
                                stroke-width="1.33333"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                  ...
                  <div className="services-grid">
                    <div className="service-item">
                      ...
                      <div className="service-status">
                        ...
                        >
                          <path
                            d="M10 18.3333C14.6023 18.3333 18.3333 14.6024 18.3333 10C18.3333 5.39762 14.6023 1.66666 10 1.66666C5.39759 1.66666 1.66663 5.39762 1.66663 10C1.66663 14.6024 5.39759 18.3333 10 18.3333Z"
                            stroke="#00A63E"
                            strokeWidth="1.66667"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                ...
                <div className="quick-access-card">
                  ...
                  <div className="quick-access-list">
                    <button
                      ...
                      onClick={() => navigate("/financial-core/overview")}
                    >
                      <svg
                        width="18"
                        height="18"
                    ...
                    <button
                      className="quick-access-item"
                      onClick={() =>
                        navigate("/financial-core/treasury-liquidity")
                      }
                    >
                      <svg
                        width="18"
