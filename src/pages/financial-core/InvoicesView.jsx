...
import { getInvoiceData } from "../../apiCalls/salesAPI/salesAPICall";
import { LIST_INVOICES } from "../../services/endPoints";
...
export default function InvoicesView({ isDarkMode }) {
  ...
  const filteredInvoices = invoices.filter((invoice) => {
    ...
    const matchesCustomer =
      selectedCustomer === "All" || invoice.customer === selectedCustomer;

    // Currency filter (extract currency from amount string)
    const invoiceCurrency = invoice.amount.split(" ")[0];
    const matchesCurrency =
      selectedCurrency === "All" || invoiceCurrency === selectedCurrency;
  ...
  const handleGetInvoiceData = async () => {
    const response = await getInvoiceData(LIST_INVOICES);
    ...
    <div className={`invoices-view ${isDarkMode ? "dark-mode" : ""}`}>
        ...
        <div className="invoices-header-left">
          <div className="invoices-title-row">
            ...
            <button
              ...
              title="Information about invoices"
            >
              <svg
                width="16"
                height="16"
      ...
      <div className="invoices-filters">
        <div className="search-box-full">
          ...
          >
            <path
              d="M9.16675 15.8333C12.8486 15.8333 15.8334 12.8486 15.8334 9.16667C15.8334 5.48477 12.8486 2.5 9.16675 2.5C5.48485 2.5 2.50008 5.48477 2.50008 9.16667C2.50008 12.8486 5.48485 15.8333 9.16675 15.8333Z"
              stroke="currentColor"
              strokeWidth="1.12943"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M17.5001 17.5L13.8751 13.875"
              stroke="currentColor"
              strokeWidth="1.12943"
              strokeLinecap="round"
              strokeLinejoin="round"
            ...
            {paginatedInvoices.length > 0 ? (
              paginatedInvoices.map((invoice) => (
                ...
                >
                  ...
                  <td
                    className={`balance-due ${invoice.statusColor === "paid" || invoice.statusColor === "active" ? "paid" : "unpaid"}`}
                  >
                    {invoice.balanceDue}
                  </td>
                  <td>
                  ...
                  <td className="actions">
                    ...
                    >
                      ...
                      >
                        <path
                          d="M0.833374 9.99935C0.833374 9.99935 4.16671 3.33268 10 3.33268C15.8334 3.33268 19.1667 9.99935 19.1667 9.99935C19.1667 9.99935 15.8334 16.666 10 16.666C4.16671 16.666 0.833374 9.99935 0.833374 9.99935Z"
                          stroke="#6B7280"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                    ...
                    >
                      ...
                      >
                        <path
                          d="M18.3334 1.66602L9.16671 10.8327"
                          stroke="#6B7280"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                        />
                        <path
                          d="M18.3334 1.66602L12.5 18.3327L9.16671 10.8327L1.66671 7.49935L18.3334 1.66602Z"
                          stroke="#6B7280"
                          strokeWidth="1.5"
                          strokeLinecap="round"
                          strokeLinejoin="round"
      ...
      <div className="table-pagination">
        <div className="pagination-info">
          ...
          <span className="pagination-number">
            {String(
              Math.min(paginatedInvoices.length, resultsPerPage),
            ).padStart(2, "0")}
          </span>{" "}
